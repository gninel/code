...
export default function Sidebar() {
    ...
    const handleNavigation = (path: string) => {
        handleStaticNavigation(useRouterHook, path);
    };

    const isActive = (path: string) => {
        if (path === '/' && pathname === '/') return true;

        // For static file active state, pathname might be '/Users/.../out/design.html'
        // This is tricky. Let's start with basic Next.js behavior.
        // If window.location contains the path...

        if (typeof window !== 'undefined' && window.location.protocol === 'file:') {
            if (path === '/design' && window.location.href.includes('design.html')) return true;
            if (path === '/materials' && window.location.href.includes('materials.html')) return true; // materials/index.html -> materials
            if (path === '/homework' && window.location.href.includes('homework.html')) return true;
            if (path === '/evaluation' && window.location.href.includes('evaluation.html')) return true;
        }
