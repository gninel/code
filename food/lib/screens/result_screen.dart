        ...
        child: Column(
          ...
          children: [
            ...
            if (_analysis!.ingredients.isNotEmpty) ...[
              _buildInfoRow(l10n.get('ingredients'), _analysis!.ingredients.join(', ')),
            ...
            if (_analysis!.nutritionInfo.isNotEmpty) ...[
              _buildInfoRow(l10n.get('nutrition_info'), _analysis!.nutritionInfo),
              const SizedBox(height: 8),
            ],

            // 标签
            if (_analysis!.tags.isNotEmpty) ...[
              _buildInfoRow(l10n.get('tags'), _analysis!.tags.join(', ')),
            ],
          ],
        ),
      ),
