...
#### API 调用方式
- **接口**：豆包（抖音）多模态 API
使用豆包大模型，apikey=405fe7f2-f603-4c4c-b04b-bdea5d441319，参考接入文档：https://console.volcengine.com/ark/region:ark+cn-beijing/endpoint/detail?Id=ep-20251112223504-j8pvh&Tab=api 
