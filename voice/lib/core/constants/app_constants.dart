...
class AppConstants {
  ...
  // 录音文件转写大模型API配置
  static const String xunfeiLlmApiKey = '390583124637d47a099fdd5a59860bde';
  static const String xunfeiLlmApiSecret = 'MThmZmE0M2Y1MmUyZWQwYzU4N2ZlMzQ2';
  ...
  static const int databaseVersion = 3; // 升级到版本3以支持自传版本管理

  // 版本管理配置
  static const int maxAutobiographyVersions = 20; // 最多保存20个版本
...
class DatabaseTables {
  ...
  static const String autobiographyVersions = 'autobiography_versions';
